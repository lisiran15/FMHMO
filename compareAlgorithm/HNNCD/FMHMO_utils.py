...
## lfr网络
# lfr_path = r"data/linear_lfr1000_10000"
lfr_path = r"data/lfrNetwork/linear_lfr1000"
...
# 算法各参数设置
# =============================================================================
def FGHCD_params_set():
    # 独立运行运行次数
    Independent_Runs = 20 # 本次实验独立运行次数
    # 是否使用NCR操作
    NCR_Flag = True
    # 是否使用NCM操作
    NCM_Flag = True
    FHGCD_params = dict()
    FHGCD_params['Independent_Runs'],FHGCD_params['NCR_Flag'],FHGCD_params['NCM_Flag']  = Independent_Runs,NCR_Flag,NCM_Flag
    return FHGCD_params
...
# 将加权图社区划分转换为超图社区划分
# =============================================================================
def WGCD_to_HGCD(HG_info, WG_info, membership_c, FHGCD_params):
    # 转化成partition
    partition = {}
    ...
    # 求社区间节点
    X, X_NCM, X_NCR = HG_func.NCR_NCM(membership_c, partition, prtition_real, HG_info, WG_info, FHGCD_params, verbose=True)
