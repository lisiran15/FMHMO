...
# 社区间节点社区划分
# =============================================================================
def NCR_NCM(GWX, GWXpartition, Xpartition, HG_info, G_info, FMHMO_params, verbose=False):
    # 如果该节点为社区内节点，则不调整
    ...
    if FMHMO_params['NCR_Flag'] and FMHMO_params['NCM_Flag']:
